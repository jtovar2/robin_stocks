...
def create_session_on_db(username=None, password=None, expiresIn=691200, scope='internal', by_sms=True, dsClient=None, mfa_code=None, pickle_name=None):
    ...
    if data:
        if 'mfa_required' in data:
            ...
            resp_obj = {'verification_type':verification_type, 'user_view_id': resp['id'] ,'challenge_id': user_view['context']['sheriff_challenge']['id'], 'payload': payload, 'url': url, 'is_prompt': is_prompt}
            return resp_obj
